...
O primeiro experimento formal encontrou um resultado diferente e mais específico: os quadrantes rotacionados pelo movimento (`motion-relative`) reduziram a área A50 em 32.500 km², mas aumentaram A75 em 45.000 km², A90 em 97.500 km² e RMS em 7,69 km em relação aos quadrantes fixos (`centered`). A diferença de entropia foi pequena e incerta. A rotação revelou assimetria, mas não maior organização espacial global. O relatório completo está em [E-001](e001_orientation.md).
